...
![音色克隆](./assets/音色克隆.png)

> 📖 [如何提取人声音频？](./docs/bilibili-audio-guide.md)

**高亮跟读**

![高亮跟读](./assets/高亮跟读.png)

### 批注管理

**多色批注**

![多色批注](./assets/多色批注.png)

**批注列表**

![批注列表](./assets/批注列表.png)

### AI 智能

**AI 翻译**

![AI翻译](./assets/AI翻译.png)
